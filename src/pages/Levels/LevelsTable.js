...
export default function LevelsTable() {
  ...
  const selectBuilding = async (page) => {
    try {
      const config = {
        headers: {
  ...
  const getData = async (page) => {
    try {
      ...
      const res = await axios.get(
        `https://${params}.almnew.online/api/level-all?page=${page}`, // Increment the page by 1

        config
      );
      console.log(res);
      if (res.status === 200) {
        setData(res.data.levels.data);
        setTotalPages(res.data.levels.last_page);
      } else {
        console.log(res);
      }
    } catch (error) {
  ...
  const searchData = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        `https://${params}.almnew.online/api/level-search`,
        data,
        config
      );
      console.log(res);
  ...
  const create = async () => {
    ...
    const data = {
      name,
      code,
      building_code: selectedCity.code,
      // image,
    };
    if (image) {
      data.image = image;
    ...
    try {
      ...
      const res = await axios.post(
        `https://${params}.almnew.online/api/level-create`,
        data,
  ...
  const editHandle = async () => {
    ...
    const data = {
      ...
      building_code: selectedCity.code ? selectedCity.code : editRow.build.code,
    };
    console.log(data);
    try {
      const config = {
      ...
      const res = await axios.post(
        `https://${params}.almnew.online/api/level-update/` + editRow.id,
        data,
  ...
  const deleteHandle = async () => {
    ...
    try {
      ...
      const res = await axios.delete(
        `https://${params}.almnew.online/api/level-destroy/` + editRow.id,
  ...
  const saveProduct = async () => {
    ...
    if (uploadExcel) {
      try {
        ...
        const res = await axios.post(
          `https://${params}.almnew.online/api/level-import`,
          { file: uploadExcel },
  ...
  const deleteMultipleHandle = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        `https://${params}.almnew.online/api/level-deleteMultiple`,
        { id: idArray },
        config
      );
      console.log(res);
  ...
  useEffect(() => {
    ...
    fetch(`https://${params}.almnew.online/api/level-export`, {
      method: "GET",
      headers: {
        Authorization: `Bearer ${user.token}`,
      },
  ...
  return (
    <div className="p-2">
      ...
      <Dialog
        ...
        header={editRow ? "Edit Levels" : "Add Levels"}
        modal
        className="p-fluid"
        footer={
          <React.Fragment>
      ...
      >
        <div className="field">
          ...
          <div class="form-floating mb-4">
            ...
            {submitted && !name && (
              <small className="p-error">Levels Name is required.</small>
            )}
        ...
        <div className="field">
          ...
          <div class="form-floating mb-4">
            ...
            {!editRow && (
              <>
                {submitted && !code && (
                  <small className="p-error">Levels Code is required.</small>
                )}
              </>
            )}
